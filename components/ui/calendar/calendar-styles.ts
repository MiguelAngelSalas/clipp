...
export function getCalendarClassNames(
  ...
  return {
    root: cn("w-full max-w-fit", defaultClassNames.root),
    months: cn(
    ...
    weekday: cn(
      "text-muted-foreground rounded-md flex items-center justify-center font-normal text-[0.8rem] select-none",
